...
let virtual-env = "D:\Слава\Учеба Python_GeekBrains\Знакомство с Python\Sem_10\Calc"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\Слава\Учеба Python_GeekBrains\Знакомство с Python\Sem_10\Calc\Scripts\deactivate.nu"
